        ...
        if (response.Success == true) {
          ...
          if (response.Data.Start_Date || response.Data.End_Date) {
            ...
            startDate = <NgbDateStruct>{
              year: new Date(response.Data.Start_Date).getFullYear(),
              month: new Date(response.Data.Start_Date).getMonth() + 1,
              day: new Date(response.Data.Start_Date).getDate()
            };

            endDate = <NgbDateStruct>{
              year: new Date(response.Data.End_Date).getFullYear(),
              month: new Date(response.Data.End_Date).getMonth() + 1,
              day: new Date(response.Data.End_Date).getDate()
            };
